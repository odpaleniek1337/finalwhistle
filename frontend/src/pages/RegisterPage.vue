      ...
      <div class="row">
        <form>
          ...
          <div class="row" style="padding-left: 38px">
            ...
            <input style="width: 200px; min-width: 150px;" type="password" v-model="password" autocomplete="new-password"/>
          </div>
          <div class="row" style="padding-left: 38px">
            <div class="register-text">Confirm password:</div>
            <input style="width: 200px; min-width: 150px;" type="password" v-model="confirmPassword" autocomplete="new-password"/>
          </div>
        </form>
      </div>
      <div class="row mt-3">
